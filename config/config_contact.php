...
try {
    ...
    $mail->Username   = 'postmaster@sandbox9193718121d643d0b8410437d660181b.mailgun.org';                     //SMTP username
    $mail->Password   = '100d23b531097a892827522fce69d948-fa6e84b7-69d2fdab';  //SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;         //Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
    $mail->Port       = 587;                                    //TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above

    //Recipients
    $mail->setFrom('postmaster@sandbox9193718121d643d0b8410437d660181b.mailgun.org', 'mailer');
